...
var modalClasses = generateUtilityClasses(COMPONENT_NAME, ["root", "hidden", "backdrop"]);
...
var Modal = React7.forwardRef(function Modal2(props, forwardedRef) {
  const {
    children,
    closeAfterTransition = false,
    container,
  ...
  return (0, import_jsx_runtime4.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime4.jsxs)(Root, {
      ...rootProps,
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime4.jsx)(BackdropComponent, {
        ...backdropProps
...
//# sourceMappingURL=@mui_base_Modal.js.map
