...
function useCurrentColorScheme(options) {
  ...
  const [, setHasMounted] = React14.useState(false);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime10.jsxs)(React15.Fragment, {
  ...
  const Grid2 = React17.forwardRef(function Grid3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(GridRoot, {
      ...
      children: React17.Children.map(children, (child) => {
        var _a;
        if (React17.isValidElement(child) && isMuiElement(child, ["Grid"]) && container && child.props.container) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DPOKGEF7.js.map
